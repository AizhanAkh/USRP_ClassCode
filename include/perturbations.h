...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  /** dmeff functions */
  short has_source_delta_dmeff; /** do we need source for dmeff fluctuations?*/
  short has_source_theta_dmeff;
  short dmeff_Vrms_dynamic;
  short dmeff_Vfull_dynamic;

  int dmeff_niter_dynamic_max; /** number of iterations for ? */
